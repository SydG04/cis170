...
<html lang="en">
  ...
  <body>
    <header>
      <h1 id="logo"><a href="index.html" class="logo">KitBook</a></h1>
      <p id="CurrentDeal">
        Get Your First Box for 30% with the code <strong>TBR</strong> at
        checkout. <a href="login.html" id="join-today">Join Today</a>
      </p>
      <nav class="navbar">
